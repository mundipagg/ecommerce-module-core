...
class PTBR extends AbstractI18NTable
{
    protected function getTable()
    {
        return [
            ...
            "Can't create payment. Please review the information and try again." => "Não foi possível criar o pagamento. Por favor revise os dados e tente novamente.",
            ...
            "Can't initialize the payment service. Please contact the store administrator." => "Não foi possivel inicializar o serviço de pagamento. Por favor contate o administrador da loja.",
            "It was not possible to connect to the payment service. Please contact the store administrator." => "Não foi possivel conectar com o serviço de pagamento. Por favor contate o administrador da loja.",
        ];
    }
}