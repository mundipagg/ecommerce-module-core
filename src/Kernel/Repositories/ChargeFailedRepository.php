...
final class ChargeFailedRepository extends AbstractRepository
{
    ...
    {
        $chargeFailedTable = $this->db->getTable(AbstractDatabaseDecorator::TABLE_CHARGE_FAILED);
    ...
    protected function update(AbstractEntity &$object)
    {
        ...
        $chargeFailedTable = $this->db->getTable(AbstractDatabaseDecorator::TABLE_CHARGE);
